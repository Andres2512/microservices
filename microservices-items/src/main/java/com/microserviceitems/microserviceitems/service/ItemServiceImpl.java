...
public class ItemServiceImpl implements ItemService{
    ...
    public List<Item> findAll() {
        List<Products> products = Arrays.asList(Objects.requireNonNull(clientRest.getForObject("http://services-products/list", Products[].class)));
    ...
    public Item findById(Long id, Integer quantity) {
        ...
        Products products= clientRest.getForObject("http://services-products/details/{id}",Products.class,pathVariables);
